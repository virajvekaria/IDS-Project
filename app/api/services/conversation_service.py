...
class ConversationService:
    ...
    @staticmethod
    def update_conversation(db: Session, conversation_id: int, conversation: schemas.ConversationBase) -> Optional[Conversation]:
        """
    ...
    def get_message_references(db: Session, message_id: int) -> List[MessageReference]:
        ...
        """
        return db.query(MessageReference).filter(MessageReference.message_id == message_id).all()

    @staticmethod
    def create_message_reference(db: Session, reference: schemas.MessageReferenceCreate) -> MessageReference:
        """
